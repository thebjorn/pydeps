...
def parse_args(argv=()):
    ...
    args.add('--rankdir', default='TB', type=str, choices=['TB', 'BT'], help="set the direction of the graph, legal values are TB (default, imported modules above importing modules) "
                                                                             "and BT (opposite direction of TB)")
